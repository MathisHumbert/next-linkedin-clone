...
const Post = ({ post, modalPost }) => {
  ...
  return (
    <div
      className={`bg-white dark:bg-[#1D2225] ${
        modalPost ? 'rounded-r-lg' : 'rounded-lg'
      } space-y-2 py-2.5 border border-gray-300 dark:border-none`}
    >
      <div className='flex items-center px-2.5 cursor-pointer'>
        <Avatar src={post.userImg} className='!h10 !w10 cursor-pointer' />
      ...
      <div className='flex justify-evenly items-center dark:border-t border-gray-600/8° mx-2.5 pt-2 text-black/60 dark:text-white/75'>
        {modalPost ? (
